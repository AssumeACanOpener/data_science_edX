...
#
# .. your code here ..
print('Actual 2014 white male life expectancy:')
print(X.loc[X.Year == 2014, ['WhiteMale']])
...
print('Actual 2014 black female life expectancy:')
print(X.loc[X.Year == 2014, ['BlackFemale']])
