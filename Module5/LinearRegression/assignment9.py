...
X_train, X_test, y_train, y_test = train_test_split(accepted, room_board, test_size=0.3, random_state=7)
...
accepted = X[['Accept']]
enrolled = X[['Enroll']]
X_train, X_test, y_train, y_test = train_test_split(accepted, enrolled, test_size=0.3, random_state=7)
model.fit(X_train, y_train)
score = model.score(X_test, y_test)
...
X_train, X_test, y_train, y_test = train_test_split(accepted, failed, test_size=0.3, random_state=7)
model.fit(X_train, y_train)
score = model.score(X_test, y_test)
...
#
# .. your code here ..
features = X[['Room.Board', 'Enroll']]
accepted = X[['Accept']]
X_train, X_test, y_train, y_test = train_test_split(features, accepted, test_size=0.3, random_state=7)
model.fit(X_train, y_train) 
score = model.score(X_test, y_test)
